...
CLI gets better as the harness improves). Failing check commands are harvested into the shared inbox,
feeding the continuous self-improvement loop — the flywheel that distinguishes this from a static-
harness CLI.
"""
...
__all__ = ["FailureHarvester", "HeadlessCliSession", "InteractiveSession", "TurnResult", "run_repl"]
